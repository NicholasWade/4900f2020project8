...
class UserList(admin.ModelAdmin):
    list_display = ('user_number', 'first_name', 'last_name', 'cooking_experience', 'email')
    list_filter = ('user_number', 'first_name', 'last_name', 'cooking_experience')
    search_fields = ('user_number', 'first_name', 'last_name')
